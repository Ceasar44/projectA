    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label className="block text-sm font-medium text-owly-text mb-1.5">
          名称 <span className="text-owly-danger">*</span>
        </label>
        <input
          type="text"
          value={name}
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-owly-text mb-1.5">
            姓名 <span className="text-owly-danger">*</span>
          </label>
          <input
            type="text"
            value={name}
        ...
        <div>
          <label className="block text-sm font-medium text-owly-text mb-1.5">
            邮箱 <span className="text-owly-danger">*</span>
          </label>
          <input
            type="email"
            value={email}
      ...
      <div>
        <label className="block text-sm font-medium text-owly-text mb-1.5">
          部门 <span className="text-owly-danger">*</span>
        </label>
        <select
          value={departmentId}
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-owly-text">
        确定要删除 <strong>{label}</strong> 吗？此操作无法撤销。
      </p>
...
export default function TeamPage() {
  ...
  const tabs = [
    { key: "departments" as const, label: "部门", icon: Building2 },
  ...
  return (
    <>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {activeTab === "departments" ? "添加部门" : "添加成员"}
            </button>
          </div>
        </div>
      ...
      <Modal
        ...
        title={memberModal.editing ? "编辑成员" : "新建成员"}
      >
        <MemberForm
