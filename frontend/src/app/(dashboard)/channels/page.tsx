      ...
      <div className="px-5 py-4 border-b border-owly-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-owly-text">邮箱</h3>
              <p className="text-xs text-owly-text-light mt-0.5">
...
function PhoneCard({
  ...
  const voiceOptions = [
  { id: "", label: "选择声音..." },
  { id: "rachel", label: "Rachel - 冷静、专业" },
  { id: "drew", label: "Drew - 友好、温暖" },
  { id: "clyde", label: "Clyde - 权威" },
  { id: "domi", label: "Domi - 有活力、积极" },
  { id: "bella", label: "Bella - 柔和、温柔" },
  ];
      ...
      <div className="px-5 py-4 border-b border-owly-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-owly-text">电话</h3>
              <p className="text-xs text-owly-text-light mt-0.5">
      ...
      <div className="flex-1 overflow-auto p-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <p className="font-medium text-owly-text">无法加载渠道</p>
