    ...
    try {
      ...
      const checklist: ChecklistItem[] = [
        ...
        },
        {
          id: "ai",
          title: "AI 已配置",
          description: "使用 API Key 连接 AI 服务商",
          href: "/settings",
        ...
        },
        {
          id: "channels",
          title: "至少连接一个渠道",
          description: "连接 WhatsApp、邮箱或电话渠道",
          href: "/channels",
    ...
    <div className="bg-owly-surface rounded-xl border border-owly-border overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-owly-border">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-owly-text">开始使用</h3>
