...
from app.rag.core.logging import setup_logging
from app.rag.core.config import settings, _cwl_fp
from app.rag.core.exceptions import AppError
from app.rag.api.v1 import router as v1_router
...
async def lifespan(app: FastAPI):
    ...
    from app.rag.db.init_db import init_db
    init_db()
